...
time=(new Date()*1);this.last=time;return this;}};joDataSource=function(data){this.changeEvent=new joSubject(this);this.errorEvent=new joSubject(this);if(typeof data!=="undefined")
...
date.setDate(date.valueOf()+(offset*1000*60*60*24));return date.format("yyyy-mm-dd");}};joFileSource=function(url,timeout){this.changeEvent=new joSubject(this);this.errorEvent=new joSubject(this);if(timeout)
...
this.db.db.transaction(function(t){t.executeSql(query,args,success,error);});return this;}};function joScript(url,call,context){var node=joDOM.create('script');if(!node)
...
return str;}};joCollect={get:function(parent){return new joInterface(parent);}};joInterface=function(parent){jo.initTagMap();return this.get(parent);};joInterface.prototype={get:function(parent){parent=joDOM.get(parent);if(!parent)
...
return ui;}};joView=function(data){this.changeEvent=new joSubject(this);this.container=null;this.setContainer();if(data)
this.setData(data);else
