...
//		oninput: "keypressHandler",
//        oncopy: "copyHandler"
	},
	components: [
		{kind: "enyo.Signals", onkeypress: "keypressHandler", onkeyup: "keyupHandler", onpaste: "pasteHandler", oncopy: "copyHandler", oncut: "cutHandler" }
	],
	...
	//* @protected
	cutHandler: function() {
		console.error("cut handler");
		this.callBrowserAdapter("cut");
	},
	copyHandler: function() {
		console.error("copy handler");
		this.callBrowserAdapter("copy");
	},
	pasteHandler: function() {
        console.error("Paste handler!");
